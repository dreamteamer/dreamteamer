...
const LAYERS = {
	...
	record: ['store', 'records', 'temporal', 'fractional-index', 'filter', 'field-values', 'commit', 'events', 'history', 'template', 'yaml', 'workspace', 'check', 'namespace', 'ref', 'relations', 'env-vars'],
	// the compiled artifact both halves share
	boundary: ['runtime'],
	// the workspace compiler and the harness surface
	workspace: ['compile', 'harnesses', 'schema-ops', 'init', 'record-commands', 'semver', 'export-notebooklm', 'checkout', 'prove'],
