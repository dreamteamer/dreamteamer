...
function orientationBlock(flavor, skillsIndex) {
	const lines = [
		...
		'`.dreamteamer/manifest.yaml`). sources (write): `modules/<module>/<kind>/` — `collections/`,',
		'`skills/`, `agents/`, `commands/`, `command-bindings/`, `ui-views/`,',
		'`collection-templates/` (see manifest for channels). data: `data/`; operational records:',
